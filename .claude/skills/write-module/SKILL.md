...
Read [CONSTITUTION.md](../../../docs/CONSTITUTION.md) before changing the *schema*. This skill is about
using it.
...
1. **What is each row's subject?** A variant? A diplotype pair? A measured quantity? That picks the
   ...
   another table company. → `references/table-kinds.md`
...
`RM31`–`RM35` in [ROADMAP.md](../../../docs/ROADMAP.md): one indel spelled two ways failing to resolve,
