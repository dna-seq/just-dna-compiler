...
| [PUBMIND_ASSESSMENT.md](docs/PUBMIND_ASSESSMENT.md) | the 2026-08-28 assessment of PubMind — what it competes with (little), what it complements (a lot, upstream), what its open channel actually contains, and the phased adoption plan behind RM134 | `grep -n '^## ' docs/PUBMIND_ASSESSMENT.md` |
