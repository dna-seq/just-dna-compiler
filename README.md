...
Start at [`docs/AUTHORING.md`](docs/AUTHORING.md) — the command order end to end, what only a human
may decide, and the symptom-keyed troubleshooting guide beside it.
