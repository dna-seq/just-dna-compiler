...
### A second schema-shaped gap — a pointer that does not identify a VCF field (RM53/RM54, 0.6)

Same class as the one above: a limit of the schema, closed in 0.6, and worth keeping in the same
