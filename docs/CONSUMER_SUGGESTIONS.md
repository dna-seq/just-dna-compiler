...
## The next item is S20

**Claim ids from here, never from what this file shows.** S1–S19 are all answered and live in the
...
S1–S19 are all answered, as of 2026-08-11 — see
[CONSUMER_SUGGESTIONS_HISTORY.md](CONSUMER_SUGGESTIONS_HISTORY.md), whose contents list is the one-line
summary of every one. Five spawned roadmap items that are **still open** — **RM43**, **RM44**, **RM45**,
**RM46**, **RM47** — and [RM_TOC.md](RM_TOC.md) is the index for that half: *answered* means a consumer has a
