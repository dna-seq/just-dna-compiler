...
- **[RM54](PROPOSAL_0_6.md)** — a pointer at a multi-valued field cannot say which value. A **closed vocabulary of selection rules**, never an index. · *from* VCF_4_4_AUDIT § 2
