# Changelog — the 0.5 line and everything before it

The closed half of [CHANGELOG.md](../CHANGELOG.md), split out on 2026-08-17 because the live file had
reached 4,300 lines and the entries a reader actually needs — the current line's — sat at the top of a
document mostly about releases that had shipped long before. Newest first, same as the live file.

**Everything here shipped in 0.5.4 or earlier.** The boundary is the 0.6.0 version bump on 2026-08-12,
so the first entry below is the last one dated 2026-08-11. This file is not edited again: an entry that
needs a correction gets it in the live file, where a reader will actually see it.
...
**Filed, not built: [RM48](ROADMAP_HISTORY_0_6.md#rm48--an-hg19-coordinate-has-no-supported-path-into-a-grch38-module-and-liftover-is-the-wrong-primitive) (S22, 0.6).**
...
**Filed rather than fixed, both 0.6.** [RM45](ROADMAP_HISTORY_0_6.md#rm45--the-manifest-is-rich-about-resolution-and-silent-about-verification-so-unchecked-and-clean-are-one-state-to-a-downloader)
...
**Filed as [RM47](ROADMAP_HISTORY_0_6.md#rm47--a-bin-boundary-is-the-most-interpretive-claim-in-the-format-and-the-only-one-with-nowhere-to-cite) for 0.6**, with the four candidate repairs and why none is a one-liner — the
...
[PROPOSAL_0_5 § G3](../proposals/PROPOSAL_0_5.md)).** A module is rarely one axis, and what a curator wants is to
...
reasoning in [PROPOSAL_0_5.md § G1](../proposals/PROPOSAL_0_5.md); use cases in [USE_CASES.md §6](../USE_CASES.md).
...
`docs/proposals/PROPOSAL_0_5.md` and the approved plan. **Per-package references (added this pass):**
