...
CIVIC_NAME_IDENTITIES: tuple[CivicNameIdentity, ...] = (
    ...
    CivicNameIdentity(
        ...
        rsid="rs794727253",
        caid="CA020360",
        note=("Same allele as variant 1770 (CA020360): two CIViC records, one allele."),
    ),
    CivicNameIdentity(
        variant_id=3744,
        gene="VHL",
        name="E55fs (c.163delG)",
        chrom="3",
        start=10142009,
        ref="GG",
        alt="G",
