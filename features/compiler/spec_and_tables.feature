...
#
# Source of truth: compiler/src/just_dna_compiler/compiler.py, schema/src/just_dna_format/layout.py,
...
Feature: The spec directory and the cells inside it
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:3762
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:3658
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:571
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:559
  # text: schema/src/just_dna_format/layout.py
  @refusal @both_modes
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:3953
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:4655
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:2016
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:2031
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:1924
  @tri_state
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:1823
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:4233
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:4227
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:1723
  ...
  # source: compiler/src/just_dna_compiler/compiler.py:1633
