...
class ResolutionRow(BaseModel):
    ...
    rsid: str | None = Field(
        json_schema_extra=since("0.5.0"), default=None, description="Resolved dbSNP identifier"
    )
    ...
    alts: str | None = Field(
        json_schema_extra=since("0.5.0"), default=None, description="Alt allele(s), comma-separated"
    )
