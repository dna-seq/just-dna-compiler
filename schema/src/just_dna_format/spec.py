...
VALID_STATES: frozenset[str] = frozenset({"risk", "protective", "neutral", "significant", "alt", "ref"})
VALID_CHROMOSOMES: frozenset[str] = frozenset({str(i) for i in range(1, 23)} | {"X", "Y", "MT"})
...
class ModuleInfo(Display):
    ...
    name: str = Field(
        json_schema_extra=since("0.2.0"), description="Machine name: lowercase, underscores, no spaces"
    )
...
class Defaults(BaseModel):
    ...
    curator: str = Field(
        ...
        default="ai-module-creator",
        description="Default curator identifier",
    )
    method: str = Field(
        json_schema_extra=since("0.2.0"), default="literature-review", description="Default annotation method"
    )
    priority: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Default priority level"
    )
...
class ModuleSpecConfig(BaseModel):
    ...
    schema_version: str = Field(
        json_schema_extra=since("0.2.0"), default=SCHEMA_VERSION, description="DSL schema version"
    )
    module: ModuleInfo = Field(
        json_schema_extra=since("0.2.0"), description="Module identity and display metadata"
    )
    defaults: Defaults = Field(
        json_schema_extra=since("0.2.0"), default_factory=Defaults, description="Default variant-row values"
    )
...
class VariantRow(AuthoredModel):
    ...
    rsid: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="dbSNP identifier, e.g. rs1801133"
    )
    ...
    weight: float | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Score (positive=protective)"
    )
    ...
    conclusion: str = Field(
        json_schema_extra=since("0.2.0"), description="Human-readable interpretation for this genotype"
    )
    ...
    priority: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Priority level override"
    )
    gene: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Gene symbol, e.g. MTHFR"
    )
    phenotype: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Associated trait or phenotype"
    )
    category: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Grouping category within the module"
    )
    clinvar: bool | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Is this variant in ClinVar?"
    )
    pathogenic: bool | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="ClinVar pathogenic flag"
    )
    benign: bool | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="ClinVar benign flag"
    )
    curator: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Curator override"
    )
    method: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Annotation method override"
    )
    ...
    effect_size: float | None = Field(
        json_schema_extra=since("0.3.0"),
        default=None,
        description="Published effect magnitude (unit given by `effect_measure`).",
    )
    ...
    acmg_sf: bool | None = Field(
        json_schema_extra=since("0.4.0"),
        default=None,
        description="True when the gene is on the ACMG secondary-findings list.",
    )
    ...
    def _freeze_identity(self) -> "VariantRow":
        ...
        self.authored_ident = [
            name for name in ("rsid", "chrom", "start", "ref", "alts") if getattr(self, name) is not None
        ]
        self.locus_index = 0
        self.locus_count = 1
        return self
    ...
    def effective_clin_sig(self) -> str | None:
        ...
        return self.clin_sig or clin_sig_from_booleans(self.pathogenic, self.benign, self.clinvar)
    ...
    def _validate_identification(self) -> "VariantRow":
        ...
        if not has_rsid and not has_pos:
            raise ValueError("At least one identifier is required: provide rsid or position (chrom + start)")
        if has_pos:
...
class StudyRow(AuthoredModel):
    ...
    rsid: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="dbSNP identifier or variant key"
    )
    ...
    chrom: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Chromosome (for position-only variants)"
    )
    start: int | None = Field(
        json_schema_extra=since("0.2.0"),
        default=None,
    ...
    ref: str | None = Field(
        json_schema_extra=since("0.2.0"),
        default=None,
        description="Reference allele (position-only variants)",
    )
    ...
    pmid: str = Field(
        json_schema_extra=since("0.2.0"), description="PubMed ID or reference — free-form, must be non-empty"
    )
    population: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Study population"
    )
    p_value: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Raw p-value string (free-form)"
    )
    conclusion: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="Study-specific conclusion"
    )
    study_design: str | None = Field(
        json_schema_extra=since("0.2.0"), default=None, description="e.g. meta-analysis, GWAS"
    )
    ...
    effect_size: float | None = Field(
        json_schema_extra=since("0.3.0"),
        default=None,
        description="Per-study effect magnitude (unit given by `effect_measure`).",
    )
    effect_measure: str | None = Field(
        default=None,
        json_schema_extra={
    ...
    trait_efo_id: str | None = Field(
        json_schema_extra=since("0.3.0"),
        default=None,
        description="EFO/MONDO/OBA/HP trait ontology id(s) for this study.",
    )
    ...
    def _validate_study_identification(self) -> "StudyRow":
        ...
        if self.rsid is None and self.chrom is None:
            dangling = [
                name for name, value in (("start", self.start), ("ref", self.ref)) if value is not None
            ]
            if dangling:
                raise ValueError(
