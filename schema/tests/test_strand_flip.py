...
def test_a_genotype_the_locus_already_hosts_is_never_a_flip(genotype: str, ref: str, alts: str) -> None:
...
def test_what_is_not_established_is_reported_as_not_established(genotype: str, ref: str, alts: str) -> None:
